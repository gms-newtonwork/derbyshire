...
export const placeholderScenarioInputs: ScenarioInputs = {
  ...
  vacancyData: {
    'Amber Valley': { totalEswFte: 20, vacanciesFte: 3, totalBudgetedHrs: 750 },
    Bolsover: { totalEswFte: 15, vacanciesFte: 1, totalBudgetedHrs: 562.5 },
    Chesterfield: { totalEswFte: 18, vacanciesFte: 3, totalBudgetedHrs: 675 },
    'Derbyshire Dales': { totalEswFte: 12, vacanciesFte: 3, totalBudgetedHrs: 450 },
    Erewash: { totalEswFte: 18, vacanciesFte: 4, totalBudgetedHrs: 675 },
    'High Peak': { totalEswFte: 13, vacanciesFte: 2, totalBudgetedHrs: 487.5 },
    'North East Derbyshire': { totalEswFte: 15, vacanciesFte: 2, totalBudgetedHrs: 562.5 },
    'South Derbyshire': { totalEswFte: 14, vacanciesFte: 3, totalBudgetedHrs: 525 },
  },
};
